...
const MakeTag = {
    ...
    makeHobbyTag: function(){
        ...
        inputHobby.addEventListener('keyup', (e) => {
            if(/,/.test(inputHobby.value)){
                ...
                if(container.hasChildNodes() && inputHobby.value === Enum.NULL_CONTENT){
                    inputHobby.value = container.lastElementChild.firstElementChild.innerHTML;
